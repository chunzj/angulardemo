    ...
    sortService.guessSortFn = function(item) {
      ...
      switch (itemType) {
        ...
        case "string":
          ...
          return item.match(/^[-+]?[??$?¡è]?[\d,.]+%?$/) ? sortService.sortNumberStr : sortService.sortAlpha;
        default:
...
/// <reference path="../../lib/jquery-1.8.2.min" />
  ...
  window.ngGrid.i18n['de'] = {
    ...
    ngMenuText: 'Spalten ausw?¡èhlen:',
    ngShowingItemsLabel: 'Zeige Eintr?¡ège:',
    ngTotalItemsLabel: 'Eintr?¡ège gesamt:',
    ngSelectedItemsLabel: 'Ausgew?¡èhlte Eintr?¡ège:',
    ngPageSizeLabel: 'Eintr?¡ège pro Seite:',
    ngPagerFirstTitle: 'Erste Seite',
    ngPagerNextTitle: 'N?¡èchste Seite',
  ...
  window.ngGrid.i18n['es'] = {
    ...
    ngPageSizeLabel: 'Tama?¡Ào de P??gina:',
  ...
  window.ngGrid.i18n['fa'] = {
    ngAggregateLabel: '?¡­???¡À?????¡ì',
    ngGroupPanelDescription: '???? ???????¡ì?? ???????? ?¡ì???????¡ì ?¡À?¡ì ?¡§?¡À???¡ì?¡À ?? ?¡§?? ???¡À?????? ?¡ì?? ???? ???????? ?¡§???¡ì?????¡ì??.',
    ngSearchPlaceHolder: '??????????...',
    ngMenuText: '?¡ì???????¡ì?¡§ ????????\u200c???¡ì:',
    ngShowingItemsLabel: '???¡­?¡ì???? ?¡­???¡À?????¡ì:',
    ngTotalItemsLabel: '???¡­???¡± ?¡­???¡À?????¡ì:',
    ngSelectedItemsLabel: '?¡­???¡À?????¡ì?? ?¡ì???????¡ì?¡§\u200c??????:',
    ngPageSizeLabel: '?¡ì?????¡ì?????¡± ????????:',
    ngPagerFirstTitle: '?????????¡± ?¡ì????',
    ngPagerNextTitle: '?????????¡± ?¡§????',
    ngPagerPrevTitle: '?????????¡± ???¡§??',
  ...
  window.ngGrid.i18n['fr'] = {
    ...
    ngSelectedItemsLabel: '?¡ël??ments Articles:',
  ...
  window.ngGrid.i18n['zh-cn'] = {
    ngAggregateLabel: '??????',
    ngGroupPanelDescription: '??¨C???¨¨?¡§?¡è???¡ã??¡è?¡è????¨¨??¨¨????????',
    ngSearchPlaceHolder: '??????...',
    ngMenuText: '??¡ã????????????¨¦¢ã¡ë?????¡ª???',
    ngShowingItemsLabel: '??¡°?¡ë?????¡è??????????',
    ngTotalItemsLabel: '???????¢ã???¡ã???',
    ngSelectedItemsLabel: '¨¦¢ã¡ë????????????',
    ngPageSizeLabel: '???¨¦??????¡è???¡ã???',
    ngPagerFirstTitle: '?????¡ã¨¦?¨C¨¦??',
    ngPagerNextTitle: '?????¢ã¨¦??',
    ngPagerPrevTitle: '?????¢ã¨¦??',
    ngPagerLastTitle: '?¡ë???¢ã?¡ã?¨¦??'
  };

  window.ngGrid.i18n['zh-tw'] = {
    ngAggregateLabel: '???',
    ngGroupPanelDescription: '??¨C??¡ë¨¨?¡§¨¦ ???¡ã??¡è¨¨?????¨¦¢ã?¨¨????????',
    ngSearchPlaceHolder: '????¡ã?...',
    ngMenuText: '¨¦???¡°??????????',
    ngShowingItemsLabel: '????¡ë?¨¦???¡è??????????',
    ngTotalItemsLabel: '????????????',
    ngSelectedItemsLabel: '¨¦????¨C?????????',
    ngPageSizeLabel: '???¨¦ ?¨¦???¡è????',
    ngPagerFirstTitle: '?????¢ã¨¦ ?',
    ngPagerNextTitle: '?????¢ã¨¦ ?',
    ngPagerPrevTitle: '?????¢ã¨¦ ?',
